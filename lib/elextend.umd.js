...
// CONCATENATED MODULE: ./packages/data-render-table/src/data-render-table.vue?vue&type=template&id=06f173df&
...
var lodash_merge = __webpack_require__("42454");
...
/* harmony default export */ var data_render_tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    mergeConfig() {
      const mergedConfig = mergeInitConfig(cloneDeep_default()(initConfig), this.config);
